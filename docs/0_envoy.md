...
That's because there's nothing listening on ports `8000` and `9000`, which are the two endpoints we referenced in the cluster. Let's just run two instances of the `httpbin` service:
